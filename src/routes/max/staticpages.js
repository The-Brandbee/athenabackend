...
var staticpagesApi = require("../../api/staticpages");
...
var staticpages = {
    add: async function (req, res, next) {
        ...
        staticpagesApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        staticpagesApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      staticpagesApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      staticpagesApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    fetchByUrl:function(req, res, next) {
      ...
      staticpagesApi.fetchByUrl(req.params.url, function(err, data) {
    ...
    delete:  function(req, res, next) {
      ...
      staticpagesApi.deleteId({ id: req.body.id}, function(err, data) {
