...
var mainhadderApi = require("../../api/mainhadder");
...
var mainhadder = {
    add: async function (req, res, next) {
        ...
        mainhadderApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        mainhadderApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      mainhadderApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      mainhadderApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      mainhadderApi.deleteId({ id: req.body.id}, function(err, data) {
