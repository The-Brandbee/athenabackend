...
var awards = {
    add: async function (req, res, next) {
        ...
        awardsApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        awardsApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
  ...
  console.log(req.params.id)
      awardsApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      awardsApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      awardsApi.deleteId({ id: req.body.id}, function(err, data) {
