...
var staticcontentApi = require("../../api/staticcontent");
...
var staticcontent = {
    add: async function (req, res, next) {
        ...
        staticcontentApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        staticcontentApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      staticcontentApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      staticcontentApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      staticcontentApi.deleteId({ id: req.body.id}, function(err, data) {
