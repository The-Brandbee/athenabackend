...
var leadershipbannerApi = require("../../api/leadershipbanner");
...
var leadershipbanner = {
    add: async function (req, res, next) {
        ...
        leadershipbannerApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        leadershipbannerApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      leadershipbannerApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      leadershipbannerApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      leadershipbannerApi.deleteId({ id: req.body.id}, function(err, data) {
